...
**Status:** OPEN (drifts fixed 2026-06-13: sync-repo.ps1 + verify-file-integrity.sh + check-reference-coverage.{ps1,sh} + launch-claude-clean.ps1 + check-kit-docs.sh; the behavioral-parity check is the unbuilt part).
