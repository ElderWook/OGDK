...
**Working a dev session (human or AI)?** Follow the chain:
[**00-START-HERE.md**](./00-START-HERE.md) → `AGENTS.md` → [STATUS.md](./STATUS.md) → active plan.

## Map

- `00-START-HERE.md` — session entry chain · `STATUS.md` — live state (updated every session)
- `core/` — living specs of the *current* architecture
